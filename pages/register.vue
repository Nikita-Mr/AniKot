    ...
    <div class="layout-container flex h-full grow flex-col">
      ...
      >
        ...
        >
          ...
          >
            Регестрируйся в AniKot
          </p>
          <div class="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
            <label class="flex flex-col min-w-40 flex-1">
              <p class="text-base font-medium leading-normal pb-2">Имя</p>
              <input
                placeholder="Введите имя..."
                class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden focus:outline-0 focus:ring-0 border border-[#cfd8e7] bg-[#f8f9fc] focus:border-[#cfd8e7] h-14 placeholder:text-[#4c6a9a] p-[15px] text-base font-normal leading-normal"
                v-model="name"
              />
            </label>
          </div>
          ...
          <div class="flex px-4 py-3">
            <button type="submit" class="random block m-[auto]">Зарегистрироваться</button>
          </div>
          <p
