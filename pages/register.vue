      ...
      <div class="layout-container flex h-full grow flex-col">
        ...
        >
          <div class="flex items-center gap-4 text-[#0d131b]">
            ...
            <h2
              class="text-[#0d131b] text-lg font-bold leading-tight tracking-[-0.015em]"
            >
              MSBANK
            </h2>
          </div>
        ...
        <form class="px-40 flex flex-1 justify-center py-5" @submit.prevent="register">
          <div
          ...
          >
            ...
            >
              Log in to MSBANK and get access to your accounts
            </p>
